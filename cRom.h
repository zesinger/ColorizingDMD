...
typedef struct
{
	...
	//UINT32*		SpriteDetectDwords; // UINT32[nS] dword to quickly detect 4 consecutive distinctive pixels inside the original drawing of a sprite for optimized detection
	//UINT16*		SpriteDetectDwordPos; // UINT16[nS] offset of the above dword in the sprite description
